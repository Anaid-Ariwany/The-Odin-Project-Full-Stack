...
Step 4:
- Add a “New Book” button that brings up a form allowing users to input the details for the new book and add it to the library: _`author, title, number of pages, whether it’s been read and anything else you might want.`_ 
...
**_NB: No need for persistent storage_**

_You’re not required to add any type of storage to save the information between page reloads._