...
### Instructions
_Write tests for the following, and then make the tests pass! Remember that Jest does not have built-in stable support for ESM, so you will need to [set up Babel for Jest ESM/CJS conversion](https://www.theodinproject.com/lessons/node-path-javascript-testing-basics#using-es6-import-statements-with-jest)._
